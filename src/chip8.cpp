...
namespace c8{
    ...
    void Chip8::decodeInstruction(uint16_t ins) {
        ...
        case 0xF:
            switch (ins & 0xFF) {
            case 0x33: // FX33 store the digits of decimal representation of Vx in the 3 consecutive bytes starting from address pointed by register I
                ...
                break;
            case 0x55: // FX55
                for(uint8_t index = 0x0; index <= static_cast<uint8_t>((ins >> 8) & 0xF); ++index){
